...
//		flags += b2DebugDraw::e_centerOfMassBit;
		...
		Slimy * my_slimy;
		//todo 
		my_slimy  = [Slimy createSlimy:self x:screenSize.width/2 y:screenSize.height-50 width:0.0f height:0.0f world:world worldRatio:PTM_RATIO];
		[my_slimy fall];
		[self addChild:my_slimy->sprite];
