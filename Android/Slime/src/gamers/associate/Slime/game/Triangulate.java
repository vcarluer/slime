...
public class Triangulate {
	...
	private static float area(ArrayList<CGPoint> contour) {
		int n = contour.size();
	...
	private static boolean snip(ArrayList<CGPoint> contour, int u, int v,
			int w, int n, int[] V) {
		int p;
	...
	public static boolean process(ArrayList<CGPoint> contour,ArrayList<CGPoint> result)
	{
