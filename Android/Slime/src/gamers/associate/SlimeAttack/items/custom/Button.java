...
import gamers.associate.SlimeAttack.game.achievements.PushButtonAch;
...
public class Button extends GameItemPhysic {
	...
	protected void handleContact(ContactInfo item) {
		if (this.isEnabled) 
		{
			AchievementStatistics.buttonPushed = true;
			SlimeFactory.AchievementManager.test(PushButtonAch.class);
			this.isOn = !this.isOn;
			this.waitAnim();
