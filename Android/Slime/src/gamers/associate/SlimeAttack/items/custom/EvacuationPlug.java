...
public class EvacuationPlug extends GameItemPhysic {
	...
	private void remove() {
		SlimeFactory.Log.d(SlimeAttack.TAG, "EvacuationPlug.remove() start");
		Level.currentLevel.detachSlimies(this);
		SlimeFactory.Log.d(SlimeAttack.TAG, "destroybody start");
		this.destroyBody();
		SlimeFactory.Log.d(SlimeAttack.TAG, "destroybody end");
		...
		SlimeFactory.Log.d(SlimeAttack.TAG, "EvacuationPlug.remove() end");
	}
