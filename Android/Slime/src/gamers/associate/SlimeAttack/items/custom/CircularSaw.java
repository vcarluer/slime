...
public class CircularSaw extends GameItemPhysic implements ITrigerable {
	...
	protected void initBody() {
		...
		float bW = (this.bodyWidth * 0.75f) / this.worldRatio;
		float bW2 = bW / 2;
		float bH = (this.bodyHeight * 0.75f) / this.worldRatio;
		float bH2 = bH / 2;
		float referenceGrid = 5f;
		Vector2 p1 = new Vector2(bW / referenceGrid - bW2, bH / referenceGrid - bH2);
		Vector2 p2 = new Vector2(4 * bW / referenceGrid - bW2, bH / referenceGrid - bH2);
		Vector2 p3 = new Vector2(bW - bW2, 2 * bH / referenceGrid - bH2);
		Vector2 p4 = new Vector2(bW - bW2, 4 * bH / referenceGrid - bH2);
		Vector2 p5 = new Vector2(4 * bW / referenceGrid - bW2, bH - bH2);
		Vector2 p6 = new Vector2(bW / referenceGrid - bW2, bH - bH2);
		Vector2 p7 = new Vector2(0 - bW2, 4 *  bH / referenceGrid - bH2);
		Vector2 p8 = new Vector2(0 - bW2,2 *  bH / referenceGrid - bH2);
