...
import gamers.associate.SlimeAttack.game.CameraManager;
...
public class LevelLayer extends CCLayer {
	...
	@Override
	public void onEnter() {
		SlimeFactory.Log.d(SlimeAttack.TAG, "LevelLayer.onEnter() start");
		super.onEnter();		
...
//		}
		...
		SlimeFactory.Log.d(SlimeAttack.TAG, "LevelLayer.onEnter() end");
	}

	@Override
	public void onExit() {
		SlimeFactory.Log.d(SlimeAttack.TAG, "LevelLayer.onExit() start");
		super.onExit();
		...
		SlimeFactory.Log.d(SlimeAttack.TAG, "LevelLayer.onExit() end");
	}
	...
	public boolean ccTouchesMoved(MotionEvent event) {
		try { 	
			...
			SlimeFactory.Log.e(SlimeAttack.TAG, "ERROR during ccTouchesMoved");
		}
	...
	public boolean ccTouchesEnded(MotionEvent event) {
		try {		
			...
			SlimeFactory.Log.e(SlimeAttack.TAG, "ERROR during ccTouchesEnded");
		}
	...
	public boolean ccTouchesBegan(MotionEvent event) {	
		try {
			...
			SlimeFactory.Log.e(SlimeAttack.TAG, "ERROR during ccTouchesBegan");
		}
